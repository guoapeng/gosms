...
func main() {
	...
	msgJSON := `{code:"1234"}`           
	if response, err := suite.sender.Send("13288888888", msgJSON, "SMS_9999999"); err ==nil {  // SMS_9999999 is message template id defined in aliyun's sms service
		if "OK" == response.Code {
